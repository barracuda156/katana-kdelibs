    ...
    : QListView(parent), d(new Private(this))
{
    ...
    d->adaptItemsTimeline.setEasingCurve(QEasingCurve(QEasingCurve::InOutSine));
    ...
    d->itemAppearTimeline.setEasingCurve(QEasingCurve(QEasingCurve::InOutSine));
    ...
    d->itemDisappearTimeline.setEasingCurve(QEasingCurve(QEasingCurve::InOutSine));
