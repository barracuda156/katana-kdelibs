...
public:
     ...
     * text should contain the complete translated text of
     * of the error message.
     *
     * For all other error codes, text should match the corresponding
     * error code. Usually,, text is a file or host name, or the error which
     * was passed from the server.<br>
     * For example, for KIO::ERR_DOES_NOT_EXIST, text may only
     ...
     * For a complete list of what text should contain for each error code,
     ...
     * @param errid the error code from KIO::Error
     * @param text the rich text error message
     */
     ...
     * @param entry The UDSEntry containing all of the object attributes.
     */
    void listEntries(const UDSEntryList &entry);
